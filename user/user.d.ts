...
import type * as AuthType from "./auth/auth.t";
import type * as BalanceType from "./balance/balance.t";
import type * as DepositType from "./payment/deposit/deposit.t";
import type * as TransferType from "./payment/transfer/transfer.t";
import type * as UserType from "./user/user.t";
